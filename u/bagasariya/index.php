...
<nav class="w3-sidebar w3-blue-grey w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:250px" id="mySidebar"><br>
  <div class="w3-display-container">
    <center><img src="<?= ($d_user['user_logo'] != NULL or $d_user['user_logo'] != '') ? '../../images/user/'.$d_user['user_logo'] : '../../images/user/icon.png'; ?>" class="w3-circle"style="max-width:150px; min-height:150px;"></center>
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-bar w3-small" style="margin-top:30px;">
    <center>
