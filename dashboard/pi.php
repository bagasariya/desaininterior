              ...
              <div class="active tab-pane" id="pi">
                ...
                <div class="col-md-4">
                  <div class="form-group"> 
                        ...
                        <div class="col-sm-12">
                          <img class="col-md-8 img-responsive" id="image-placeholder" src="../images/user/<?php echo $res['user_logo'];?>" style="object-fit: cover" alt=""/>
                        </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="box-footer">
                    ...
                    <input type="submit" class="btn btn-warning pull-right" value="Save" name="submit1" style="margin-left:300px">
                  </div>
                </div>
                </div>
                </form>
