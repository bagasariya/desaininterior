<?php
  ...
  $query = "select * from view_user_post order by rand() limit 4 where status='published'";
  session_start();
  if (isset($_POST['submit'])) {
    ...
    if(mysql_num_rows($res) != 0) {
      ...
      login_validate();
      echo "<script type='text/javascript'>alert('LOGIN SUCCESSFUL'); document.location = 'dashboard/'</script>";    
    } else {
  ...
  <div class="w3-bar w3-theme-d2 w3-left-align">
      ...
      <?php
        if($_SESSION['logged_in'] == null){
            ...
            <div class='w3-dropdown-hover w3-right'>
              ...
              <div class='w3-dropdown-content w3-border' style='right:0;'>
                <form class='w3-container' method='post'>
                  ...
                  <br>
                  <input type='submit' class='w3-btn w3-blue-grey' value='Submit' name='submit'>
                  <br>
                  <p>Belum punya Akun? <a href='login.php' id='btn-1'>Sign Up</a></p>
                </form> 
              </div>
            </div>
          ";
          ...
          echo "
            <a href='logout.php' class='w3-bar-item w3-button w3-hide-small w3-hover-white w3-right'>Logout</a>
          ";
        }
      ?>
  </div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-row-padding w3-padding-64 w3-center" id="porto">
    ...
    <div class="w3-quarter">
      <img src="<?php $row['image_link']; ?>" alt="Sandwich" style="width:100%">
      <div class="w3-container">
        <h3><a href="fontend/tekan-nia.php?"> <?php echo $row['user_real_name']; ?> </a></h3>
